...
public interface EventDAO {
	...
	/**
	 * permet de recuperer une liste d'evenements dont l'utilisateur fait parti
	 * 
	 * @param idUser
	 *            id de l'utilisateur
	 */
	...
	/**
	 * permet de recuperer une liste d'evenements dont l'utilisateur ne fait pas parti
	 * 
	 * @param idUser
	 *            id de l'utilisateur
	 */
